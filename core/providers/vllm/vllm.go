...
func (provider *VLLMProvider) PassthroughStream(_ *schemas.BifrostContext, _ schemas.Key, _ *schemas.BifrostPassthroughRequest) (*schemas.BifrostPassthroughStreamResponse, *schemas.BifrostError) {
